export const Citation = ({ label, index, content }) => /* html */ `
...
export const CitationReference = ({
  ...
  <fabric-citation>
    ...
    <fabric-citation-reference citation-href="${href}">
      <span slot="index">${index}</span>
      <span slot="label">${label}</span>
      <span slot="metadata-text-one">${meta1}</span>
      <span slot="metadata-text-two">${meta2}</span>
